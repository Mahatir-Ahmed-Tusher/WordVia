...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About WordVia - Our Story</title>
        <meta
          name="description"
          content="Learn about the origins of WordVia, a word game that started with pen and paper and evolved into a digital experience."
        />
      </Helmet>
